    ...
    <div className='container  py-[120px]'>
            <div className='row flex justify-center '>
                <div className='w-[440px] bg-[#F0F0F0] rounded-[33px] py-[25px] px-[25px]'>
                    <h1 className='text-center font-adamina font-semibold text-[36px] text-black mb-[60px]'>Register</h1>
                    {/* ---------- User Name input ------------ */}
                    <div className='mt-[25px]'>
                        <h2 className='font-adamina font-medium text-[17px] text-black ml-[7px] mb-[7px]'>User Name</h2>
                    ...
                    <div className='mt-[25px]'>
                        ...
                        <h2 className='mt-[25px] font-medium text-[17px] text-black font-adamina flex justify-center'>Already a member? <Link to={'/login'} className='text-[#0EA5E9]'> Login</Link></h2>
                    </div>
                </div>
            </div>
        </div>
